...
$(P
Bununla beraber projenizde DUB altyapısının kullanımı, hem ileride projenize yeni katılacak kişilerin kurulum ve ilk başlama maliyetlerini en aza indiriyor hem de projenizin farklı geliştiricilere dağıtılabilmesini ve yeniden yapılandırma sürecini çok kolaylaştırıyor. Kısaca deneyin, seveceğinizi düşünüyorum. ;$(PARANTEZ_KAPA). Yazı hakkındaki sorularınızı $(LINK2 http://ddili.org/forum/forum, forum bölümünde) sorabilirsiniz.
)
