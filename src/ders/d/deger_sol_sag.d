...
$(P
$(IX isRef) Parametrenin gerçekte sol değer mi yoksa sağ değer mi olduğu $(C static if)'i $(C __traits(isRef)) ile kullanarak öğrenilebilir:
)

---
void onArttır()(auto ref int değer) {
    $(HILITE static if) (__traits($(HILITE isRef), değer)) {
...
$(P
$(C static if)'i ve $(C __traits)'i daha sonra $(LINK2 /ders/d/kosullu_derleme.html, Koşullu Derleme bölümünde) göreceğiz.
)
