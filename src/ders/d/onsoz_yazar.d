...
$(P
Programcılık yeni araçlar, yöntemler, ve kavramlar öğrenmeyi gerektiren çok doyurucu bir uğraştır. D programcılığından en az benim kadar hoşlanacağınızı umuyorum. Programlama dilleri başkalarıyla paylaşıldığında hem daha kolay öğrenilir hem de çok daha zevklidir. Çeşitli $(LINK2 http://ddili.org/forum/forum, D forumlarını) izlemenizi ve o forumlara katkıda bulunmanızı öneririm.
)

$(P
Bu kitap $(LINK2 http://ddili.org/ders/d.en/, İngilizce)'ye de çevrilmiştir.
)
...
$(BR)
Ali Çehreli$(BR)
Mountain View, $(I Mayıs 2017)
)

$(P
$(BR)
$(BR)
Kitabın bu sürümü çok sayıda $(LINK2 https://bitbucket.org/acehreli/ddili/commits/all, düzeltme ve geliştirmenin) yanında yeni bir bölüm de içeriyor: $(LINK2 /ders/d/static_foreach.html, $(C static foreach)).
$(BR)
$(BR)
Ali Çehreli$(BR)
Mountain View, $(I Şubat 2019)
)
