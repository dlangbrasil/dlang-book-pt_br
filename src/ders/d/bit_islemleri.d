...
$(P
Bu yüzden, aksine bir neden olmadığı sürece aşağıda gösterilenler gibi bit işlemlerinde her zaman için işaretsiz türler kullanılır: $(C ubyte), $(C ushort), $(C uint), ve $(C ulong).
)
...
$(P
Ben üst bitin özel anlamı nedeniyle işaretli türleri gözardı edeceğim ve bu örneklerde $(C uint) türünü kullanacağım. Siz buradaki işlemleri $(C ubyte), $(C ushort), ve $(C ulong) türleriyle; ve işaret bitinin önemini hatırlamak şartıyla $(C byte), $(C short), $(C int), ve $(C long) türleriyle de deneyebilirsiniz.
)
