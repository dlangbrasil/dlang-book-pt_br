...
$(P
D'de üç bitlik tür yoktur. Olsaydı, tutabildiği 8 farklı değer ile ancak $(I atılan zarın sonucu) veya $(I haftanın gün sayısı) gibi kavramları ifade etmek için kullanılabilirdi.
)
...
$(P
$(IX experimental.checkedint) $(IX Checked) Taşma gibi sorunlara karşı etkili bir başka modül, $(C Checked) türünü tanımlayan $(LINK2 https://dlang.org/phobos/std_experimental_checkedint.html, std.experimental.checkedint modülüdür). Ancak, hem kullanımı hem de gerçekleştirmesi kitabın bu noktasında fazla ileri düzey kabul edilmelidir.
)
