...
$(P
Otomatik sayaç olanağı yalnızca dizilerde bulunur. $(C foreach) başka çeşit türlerle kullanılırken sayaç gerektiğinde iki seçenek vardır:
)

$(UL
$(LI Daha sonra $(LINK2 /ders/d/foreach_opapply.html, Yapı ve Sınıflarda $(C foreach) bölümünde) göreceğimiz $(C std.range.enumerate)'ten yararlanmak.)

$(LI Bir sayaç değişkeni tanımlamak ve elle arttırmak.)

---
    size_t $(HILITE sayaç) = 0;
