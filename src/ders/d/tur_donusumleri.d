...
$(P
$(IX bool, tek bitlik tamsayı) $(IX tek bitlik tamsayı) $(IX bir bitlik tamsayı) $(IX 1 bitlik tamsayı) $(C bool) mantıksal ifadelerin doğal türü olduğu halde, yalnızca iki değeri olması nedeniyle tek bitlik bir tamsayı gibi görülebilir ve bazı durumlarda öyle işlem görür. $(C false) 0'a, $(C true) da 1'e otomatik olarak dönüşür:
)
