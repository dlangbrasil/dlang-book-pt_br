...
$(P
$(C pure) işlevlerin bir yararı, dönüş değerlerinin $(C immutable) değişkenleri ilklemek için kullanılabilmesidir. Aşağıdaki işlevin üretmekte olduğu dizi değişebilen çeşitten olduğu halde o dizinin elemanlarının $(C diziYap) işlevi dışındaki kodlar tarafından değiştirilmesi olanaksızdır. Bu yüzden, $(C immutable) bir dizinin ilklenmesinde bir sakınca yoktur.
)
...
$(LI Gösterge değeri değiştirilemez (gösterge $(I aritmetiği) yapılamaz; ancak, bir gösterge kendi türünden olan başka bir göstergeye atanabilir).)
