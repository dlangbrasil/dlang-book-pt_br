...
$(P
$(I Not: Bir önceki bölümde gördüğümüz gibi, parametre değerleri çokuzlu olduğundan, yukarıdaki $(C foreach) bir) derleme zamanı $(C foreach)'idir.
)
...
$(P
Bazı durumlarda ise şablon parametrelerinin açıkça belirtilmeleri gerekebilir. Örneğin, $(C std.conv.to) şablonu hedef türü açıkça belirtilmesi gereken bir şablon parametresi olarak alır:
)
