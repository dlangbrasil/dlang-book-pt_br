...
$(P
Hem daha önceki bölümlerde hem de bu bölümde $(I iş yapmaktan) söz ettim. Program adımlarının, ifadelerin, işlevlerin, $(I iş yaptıklarını) söyledim. İş yapmak, değer üretmek veya yan etki oluşturmak anlamına gelir:
)
...
$(LI
$(B Hem değer üretmek, hem yan etki oluşturmak:) Bazı işlemler hem değer üretirler, hem de yan etkileri vardır. Örneğin girişten okuduğu sayıların toplamını hesaplayıp döndüren bir işlev, hem toplamın sonucunu üretmektedir; hem de içinden karakterler çıkarttığı için girişi etkilemektedir.
)
