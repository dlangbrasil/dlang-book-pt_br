...
$(P
$(C assert) hangi kaynak dosyanın hangi satırındaki beklentinin gerçekleşmediğini de bildirir. (Bu mesajda $(C deneme.d) dosyasının ikinci satırı olduğu anlaşılıyor.)
)
