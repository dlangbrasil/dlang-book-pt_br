...
$(P
$(C readf) aslında $(C &) karakteri olmadan da kullanılabilir:
)
...
$(P
Her ne kadar $(C &) kullanılmadığında kod daha okunaklı ve güvenli olsa da, sizi hem $(LINK2 /ders/d/deger_referans.html, referans kavramına) hem de $(LINK2 /ders/d/islev_parametreleri.html, parametrelerin referans olarak geçirilmeleri kavramına) alıştırmış olmak için $(C readf)'i bu kitapta göstergelerle kullanmaya devam edeceğim.
)
