...
$(P
$(IX kullanıcı türü) Yapılar temel türleri, başka yapıları, veya sınıfları bir araya getirerek yeni türler oluşturmaya yarayan olanaklardır. Yeni tür $(C struct) anahtar sözcüğü ile oluşturulur. Bu tanıma göre, yapılar $(I kullanıcı türleridir.) $(C struct), "yapı" anlamına gelen "structure"ın kısaltmasıdır.
)
...
---
void zamanEkle(GününSaati başlangıç,
...
---
$(CODE_NAME zamanEkle)GününSaati zamanEkle(GününSaati başlangıç,
                     GününSaati eklenecek) {
    GününSaati sonuç;
