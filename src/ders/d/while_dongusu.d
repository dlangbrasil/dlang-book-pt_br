...
$(H5 $(IX döngü, sonsuz) $(IX döngü, koşulsuz) $(IX sonsuz döngü) $(IX koşulsuz döngü) Koşulsuz döngü)

$(P
$(C break) deyiminin kullanıldığı bazı durumlarda bilerek $(I koşulsuz döngü) oluşturulur ve $(C break) deyimi o döngünün tek çıkışı olur. (Tam doğru olmasa da koşulsuz döngü yerine $(I sonsuz döngü) dendiği de olur.) Koşulsuz döngü oluşturmak için $(C while)'a sabit $(C true) değeri verilir. Örneğin, kullanıcıya bir menü göstererek ondan bir komut bekleyen aşağıdaki program, ancak kullanıcı özellikle istediğinde bu döngüden çıkmaktadır:
)
...
void main() {
    // Koşulsuz döngü, çünkü mantıksal ifade hep true:
    while (true) {
...
$(P
($(I Not: Koşulsuz döngülerden hata atılınca da çıkılabilir. Hata atma düzeneğini daha sonraki bir bölümde göreceğiz.))
)
