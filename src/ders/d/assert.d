...
$(P
Hatanın $(C @) karakterinden sonra gelen bölümü hangi dosyanın hangi satırındaki varsayımın doğru çıkmadığını gösterir. Bu örnekteki $(C deneme(2))'ye bakarak hatanın $(C deneme.d) dosyasının ikinci satırında olduğu anlaşılır.
)
...
$(SHELL
core.exception.AssertError@deneme.d(2): $(HILITE Yaş sıfırdan küçük olamaz)
)
