...
struct Kesir {
    ...
    ref Kesir opOpAssign(string işleç)(Kesir sağdaki)
            if (işleç == "+") {
    ...
    Kesir opBinary(string işleç)(Kesir sağdaki) const
            if (işleç == "+") {
    ...
    int opCmp(const Kesir sağdaki) const {
     ...
     * karar verirdi. */
    bool opEquals(const Kesir sağdaki) const {
