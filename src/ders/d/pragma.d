...
$(P
$(IX StopWatch, std.datetime.stopwatch) Bu program döngünün ne kadar sürede işletildiğini $(C std.datetime.stopwatch.StopWatch) ile ölçmektedir:
)
...
$(P
Örneğin, $(C override) bir D anahtar sözcüğü olduğundan bir C kütüphanesinin $(C override) ismindeki bir işlevi D kodundan çağrılamaz. İşlevin farklı bir isimle çağrılması ama yine de kütüphanenin $(C override) isimli işlevine bağlanması gerekir:
)
...
void main() {
    ...
    auto s = $(HILITE c_override)("merhaba");
}
---
