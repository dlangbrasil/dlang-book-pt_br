...
$(P
$(I $(B Note:) UFCS considers only functions that are defined at module scope; for example, $(LINK2 /ders/d.en/nested.html, nested functions) cannot be called with the UFCS syntax.)
)
