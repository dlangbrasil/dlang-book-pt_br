...
$(P
This book is available in $(LINK2 http://ddili.org/ders/d/, Turkish) as well.
)
...
$(BR)
$(BR)
This revision of the book contains many $(LINK2 https://bitbucket.org/acehreli/ddili/commits/all, corrections, improvements), and a new chapter: $(LINK2 /ders/d.en/static_foreach.html, $(C static foreach)).
$(BR)
$(BR)
Ali Çehreli$(BR)
Mountain View, $(I February 2019)
)
