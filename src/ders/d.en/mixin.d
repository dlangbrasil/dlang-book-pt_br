...
$(P
Another option for debugging string mixins is $(LINK2 /ders/d.en/pragma.html, $(C pragma(msg))), which would print the generated code during compilation. This option is less practical because it requires replacing the $(C mixin) keyword with $(C pragma(msg)) temporarily for debugging:
)
